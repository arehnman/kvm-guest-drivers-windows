...
6. Repeat step 1-5 build wow64 mesa `meson setup .. --prefix=$env:MESA_PREFIX_WOW64  -Dgallium-drivers=virgl -Dgallium-d3d10umd=true -Dgallium-wgl-dll-name=viogpu_wgl_wow64 -Dgallium-d3d10-dll-name=viogpu_d3d10_wow64 -Dvulkan-drivers=virtio -Dzlib=disabled -Db_vscrt=mt -Dc_std=c11`
